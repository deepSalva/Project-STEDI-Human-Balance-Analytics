...
customerslanding_node1 = glueContext.create_dynamic_frame.from_options(
    format_options={"multiline": False},
    connection_type="s3",
    format="json",
    connection_options={
        "paths": ["s3://sst-udacity-sparklakes/customers/landing/"],
        "recurse": True,
    },
    transformation_ctx="customerslanding_node1",
)

# Script generated for node PrivacyFilter
PrivacyFilter_node2 = Filter.apply(
    frame=customerslanding_node1,
...
CustomerTrustedZone_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://sst-udacity-sparklakes/customers/trusted/",
        "partitionKeys": [],
    },
